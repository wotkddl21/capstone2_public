...
var MapApi = () => {
    ...
    useEffect(() => {
		...
		var options = {
			...
			center: new kakao.maps.LatLng(37.55387536257194, 126.9367147903572),
			level: 4
		};
     ...
     /*  var geocoder = new kakao.maps.services.Geocoder();
        ...
        var positions = [
            {
                ...
                latlng: new kakao.maps.LatLng(37.55498, 126.93323),
                id : '5fb9b57a793d993238ea023f',
        /*      polyline : new kakao.maps.polyline({
                    path : [
                        new kakao.maps.LatLng(37.55387536257194,126.9367147903572),
                        new kakao.maps.LatLng(37.55498,126.93323)
                        ],
                }),
        ...
        for (var i = 0; i < positions.length; i ++) {
            ...
            kakao.maps.event.addListener(marker, 'click', clickListener(positions[i].id));
