...
function ChargePage2(props) {
    ...
    return (
        <div className="app">
            ...
            <br></br>
            <p>충전 후 포인트 : {Mypoint + Point}p</p>
            <img src={`http://localhost:5000/uploads/payment_icon_yellow_medium.png`} onClick={ (e)=>charge()}></img>
            
        </div>
    )
}
//<button type="button" onClick={ (e)=>charge()} id="charge_kakao"> <img src={`http://localhost:5000/uploads/payment_icon_yellow_medium.png`}></img></button>
